...
class HttpRequestImpl : public HttpRequest
{
  public:
    ...
    {
        _path = HttpUtils::urlDecode(std::string(start, end));
    }
    ...
    virtual const cnet::Date &receiveDate() const override
    {
        return _date;
    }
    void setReceiveDate(const cnet::Date &date)
    {
        _date = date;
    }
    void setPeerAddr(const cnet::InetAddress &peer)
    {
        _peer = peer;
    }
    void setLocalAddr(const cnet::InetAddress &local)
    {
        _local = local;
    }
  ...
  private:
    ...
    cnet::InetAddress _peer;
    cnet::InetAddress _local;
    cnet::Date _date;
