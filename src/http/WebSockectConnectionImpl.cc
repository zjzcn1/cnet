...
WebSocketConnectionImpl::WebSocketConnectionImpl(const cnet::TcpConnectionPtr &conn)
    : _tcpConn(conn),
...
const cnet::InetAddress &WebSocketConnectionImpl::localAddr() const
{
    return _localAddr;
}
const cnet::InetAddress &WebSocketConnectionImpl::peerAddr() const
{
    return _peerAddr;
}
